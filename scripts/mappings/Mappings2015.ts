import SwitchingLightSubsystem = require("../subsystems/2015/SwitchingLightSubsystem");
import MovingLightSubsystem = require("../subsystems/2015/MovingLightSubsystem");
import GameSpecificStatsSubsystem = require("../subsystems/2015/GameSpecificStatsSubsystem");
...
export class ResultObject2015 extends ResultObject implements IExResObject {
  public setupGameManager(gameManager: GameManager) : void {
    ...
    if (this.getGameType() == GameType.Alliance) {
      gameManager.subsystems["MovingLightSubsystem"] = new MovingLightSubsystem(gameManager);
    } else {
